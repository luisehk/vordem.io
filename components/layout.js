  ...
  render() {
    return (
      <> 
        ...
        <aside className={"hero-nav is-hidden-desktop " + (this.state.displayMobileMenu ? 'show' : '')}>
            ...
            <div className="one-col is-table">
                <div className="one-col is-table">
                    <ul className={"is-table-cell has-list has-text-centered" + (this.state.displayMobileMenu ? 'aside-overflow-active' : '')} id="aside-menu">
                        <Link href="/">
